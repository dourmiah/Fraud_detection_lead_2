# Attention, faut se rappeler que qu'on faisait les prédictions en utilisant QUE les numériques 
...
if __name__ == "__main__":
    ...
    # Filtre et garde que les colonnes attendues pour faire tourner le modèle (vire aussi la colonne is_fraud)
